package com.hha.heinhtetaung.movieshelf.Network;

import android.os.AsyncTask;
import android.util.Log;

import com.google.gson.Gson;
import com.hha.heinhtetaung.movieshelf.Network.responses.GetMoviesResponse;
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Log.d(MovieShelfApp.Log_TAG, "getMoviesResponse movies size : " + getMoviesResponse.getPopularMovies().size());
